...
export function getProductionRolloutCsvTemplateReadme(outputDirectoryName = "rollout-csv") {
  const lines = [
    ...
    "```",
    "",
    "To split the blank files into owner-specific folders, run:",
    "",
    "```bash",
    "pnpm rollout:owner-packets --out rollout-owner-packets",
    "```",
    "",
    "To create a complete owner handoff kit with folders, status, and request docs, run:",
    "",
    "```bash",
    ...
    "```",
    "",
    "If you have one launch owner approval sheet, create the owner file before final packet checks:",
    "",
    "```bash",
    `pnpm rollout:launch-owner-import --owners launch-owners-source.csv --out-dir ${outputDirectoryName}`,
    "```",
    "",
