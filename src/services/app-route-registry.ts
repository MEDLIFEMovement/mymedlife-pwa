...
const appRouteRegistry: AppRouteRegistryItem[] = [
  ...
  { href: "/app/stories", label: "Member stories", routeType: "exact" },
  ...
  { href: "/admin/users", label: "Admin users", routeType: "exact" },
  { href: "/admin/chapters", label: "Admin chapters", routeType: "exact" },
  { href: "/admin/access", label: "Admin access matrix", routeType: "exact" },
  ...
  { href: "/admin/integrations/databricks", label: "Admin Databricks export", routeType: "exact" },
