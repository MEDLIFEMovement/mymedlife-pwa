...
function getProofReviewItems(routeBase: "/staff" | "/coach"): StaffProofReviewItem[] {
  return staffProofQueueSeeds.map((item) => ({
    ...
    sharingStatusLabel: item.visibilityLabel,
  ...
  const cards: StaffBestPracticeCard[] = [
    {
      ...
      engagementScore: 97,
      summary:
        "Stanford turned a busy event weekend into clear lead capture and follow-up.",
      whyItWorked:
    ...
    },
    {
      ...
      engagementScore: 92,
      summary:
        "Berkeley made member completion easier with a short repeatable coach cadence.",
      whyItWorked:
    ...
    },
    {
      ...
      engagementScore: 88,
      summary:
        "UNAM connected personal travel stories to stronger RSVP conversion.",
      whyItWorked:
    ...
    },
    {
      ...
      engagementScore: 85,
      summary:
        "Florida used faculty partnership to turn tabling into higher-intent traffic.",
      whyItWorked:
    ...
    },
    {
      ...
      engagementScore: 81,
      summary:
        "USP linked peer recruitment, event attendance, and chapter points in one loop.",
      whyItWorked:
