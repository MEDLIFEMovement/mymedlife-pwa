...
import { Phase2AuthOnboardingPanel } from "@/components/phase-2-auth-onboarding-panel";
...
export const metadata = getStaticRouteMetadata("adminAuthOnboarding");
export const dynamic = "force-dynamic";

export default async function AdminAuthOnboardingPage() {
  ...
  return (
    <AppShell actor={actor}>
      ...
      {!canReadFoundation(actor.audience) ? (
        <RestrictedState
          title="Auth and onboarding review is hidden for this role."
        ...
        <Phase2AuthOnboardingPanel
          packet={getPhase2AuthOnboardingFoundationPacket()}
        />
      )}
    </AppShell>
  );
