import type { SltPromotionCampaignPlan } from "@/services/slt-promotion-campaign";

type SltPromotionCampaignPanelProps = {
  plan: SltPromotionCampaignPlan;
};

export function SltPromotionCampaignPanel({
  plan,
}: SltPromotionCampaignPanelProps) {
  if (!plan.canReadPlan) {
    return null;
  }
