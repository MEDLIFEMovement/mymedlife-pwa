        ...
        <div className="bg-[#1B4B8E] px-5 pb-7 pt-12 text-white">
          ...
          <div className="mt-4 space-y-1.5">
            ...
            <div className="h-2.5 overflow-hidden rounded-full bg-white/20">
              <div className="h-full rounded-full bg-[#F5A623]" style={{ width: "67%" }} />
            </div>
          </div>
        </div>
        ...
        <section className="space-y-5 px-4 pt-5">
          <div className="rounded-2xl border border-[#d8e3f8] bg-white p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-[#7a5a5a]">Luma event live · RSVP path visible</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <StudentKpiCard label="Events" value={summary.linkedMockEvents} note="mock-linked" />
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                ["General Members", "Invite friends · RSVP · attend the event", "1/3 done"],
                ["Action Committee Chairs", "Coordinate tabling · track leads · brief members", "3/5 done"],
                ["E-Board", "Review KPIs · manage Luma · assign tasks", "4/6 done"],
              ].map(([role, example, done]) => (
                <Link
                  key={role}
                ...
                >
                  <div className="mb-2 flex items-center justify-between">
                    <p className="text-sm font-bold text-[#1a0a0a]">{role}</p>
                    <span className="font-mono text-xs font-semibold text-[#7a5a5a]">{done}</span>
                  </div>
                  <p className="text-xs text-[#7a5a5a]">{example}</p>
                </Link>
              ))}
            </div>
          </div>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-bold text-[#1a0a0a]">Rush Month Info Night</p>
              <p className="text-xs text-[#4c668b]">Open event · RSVP · attendance · points</p>
            </div>
