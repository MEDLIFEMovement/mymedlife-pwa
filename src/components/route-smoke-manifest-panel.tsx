    ...
    <section className="rounded-[2rem] border border-[var(--mymedlife-focus-blue)]/20 bg-[var(--mymedlife-focus-blue)]/10 p-5">
      ...
      <div className="mt-5 grid gap-3">
        {manifest.routes.map((route) => (
          <article key={route.path} className="rounded-2xl bg-[var(--mymedlife-border)]/40 p-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                {route.mobileReview ? (
                  <div className="mt-3 rounded-2xl border border-[var(--mymedlife-focus-blue)]/20 bg-[var(--mymedlife-focus-blue)]/10 p-3">
                    <div className="flex flex-wrap gap-2">
              ...
              <div className="flex max-w-md flex-wrap gap-2">
                {route.audiences.map((audience) => (
                  <span
                    ...
                    className="rounded-full border border-[var(--mymedlife-focus-blue)]/20 bg-[var(--mymedlife-focus-blue)]/10 px-3 py-1 text-xs font-semibold text-[var(--mymedlife-badge-background)]"
                  >
