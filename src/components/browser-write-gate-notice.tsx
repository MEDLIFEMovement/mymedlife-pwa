    ...
    <section className="app-surface-info rounded-[2rem] p-5">
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        <div className="app-surface rounded-2xl p-3">
          <p className="text-sm font-semibold text-emerald-700">Ready pieces</p>
        ...
        <div className="app-surface-warm rounded-2xl p-3">
          <p className="text-sm font-semibold text-amber-700">Still blocked</p>
          <div className="mt-3 grid gap-2">
