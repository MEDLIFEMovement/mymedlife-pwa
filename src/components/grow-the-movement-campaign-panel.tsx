import type { GrowTheMovementCampaignPlan } from "@/services/grow-the-movement-campaign";

type GrowTheMovementCampaignPanelProps = {
  plan: GrowTheMovementCampaignPlan;
};

export function GrowTheMovementCampaignPanel({
  plan,
}: GrowTheMovementCampaignPanelProps) {
  if (!plan.canReadPlan) {
    return null;
  }
