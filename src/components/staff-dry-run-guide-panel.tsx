  ...
  return (
    <section className="rounded-[2rem] border border-blue-300/20 bg-blue-300/10 p-5">
      ...
      <div className="mt-5 rounded-3xl border border-blue-300/20 bg-blue-300/10 p-4">
        ...
        <p className="mt-4 rounded-2xl border border-blue-300/20 bg-blue-300/10 p-3 text-xs leading-5 text-blue-50/78">
        ...
        <div className="mt-4 grid gap-3">
          {guide.writeRehearsal.steps.map((step) => (
            <article
              key={step.operation}
              className="rounded-[1.5rem] border border-white/10 bg-[#10223f]/72 p-4"
            >
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                ...
                <span className="w-fit rounded-full bg-[#bfdbfe]/46 px-3 py-1 text-xs font-semibold text-blue-100">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#bfdbfe]/40 p-3">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Link
                      ...
                      className="rounded-full bg-blue-300 px-3 py-2 text-xs font-semibold text-[#10223f]"
                    >
                      Open packet
                    </Link>
                    <Link
              ...
              <p className="mt-3 rounded-2xl border border-blue-300/20 bg-blue-300/10 p-3 text-xs leading-5 text-blue-50/72">
          ...
          >
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex shrink-0 flex-col gap-2 lg:items-end">
                <Link
                  href={step.route}
                  className="rounded-full bg-blue-300 px-4 py-2 text-sm font-semibold text-[#08224c]"
                >
                  Open {step.route}
                </Link>
                <p className="max-w-xs rounded-xl bg-[#bfdbfe]/40 px-3 py-2 font-mono text-xs text-blue-100/78">
                  MYMEDLIFE_LOCAL_ACTOR_EMAIL={step.localActorEmail}
                </p>
              </div>
            </div>
