import type { StartAChapterCampaignPlan } from "@/services/start-a-chapter-campaign";

type StartAChapterCampaignPanelProps = {
  plan: StartAChapterCampaignPlan;
};

export function StartAChapterCampaignPanel({
  plan,
}: StartAChapterCampaignPanelProps) {
  if (!plan.canReadPlan) {
    return null;
  }
