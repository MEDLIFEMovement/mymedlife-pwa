  ...
  return (
    <label className="relative block">
      ...
      <select
        ...
        className="min-w-[14rem] appearance-none rounded-full border border-slate-200 bg-[var(--mymedlife-badge-background)] px-4 py-2.5 pr-10 text-sm font-semibold text-slate-700 shadow-[0_8px_24px_rgb(var(--mymedlife-shadow-rgb)/0.04)] outline-none transition hover:border-slate-300 focus:border-[var(--accent)]"
      >
        {options.map((option) => (
