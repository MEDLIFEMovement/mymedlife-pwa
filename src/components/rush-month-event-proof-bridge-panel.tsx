...
export function RushMonthEventProofBridgePanel({
  ...
  return (
    <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
      ...
      <div className="mt-4 rounded-2xl border border-[#f7d05e]/30 bg-[#fff8df] p-4">
        <p className="text-sm font-semibold text-[#a16207]">Review mode only</p>
      ...
      <div className="mt-3 grid gap-2 md:grid-cols-3">
        {row.steps.map((step) => (
          <div key={step.futureEventType} className="rounded-2xl border border-slate-200 bg-white p-3">
            ...
            <p className="mt-2 font-mono text-xs text-[#0f766e]">
