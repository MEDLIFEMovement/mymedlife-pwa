import type { LeadershipTransitionCampaignPlan } from "@/services/leadership-transition-campaign";

type LeadershipTransitionCampaignPanelProps = {
  plan: LeadershipTransitionCampaignPlan;
};

export function LeadershipTransitionCampaignPanel({
  plan,
}: LeadershipTransitionCampaignPanelProps) {
  if (!plan.canReadPlan) {
    return null;
  }
