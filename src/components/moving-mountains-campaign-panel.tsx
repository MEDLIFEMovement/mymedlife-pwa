import type { MovingMountainsCampaignPlan } from "@/services/moving-mountains-campaign";

type MovingMountainsCampaignPanelProps = {
  plan: MovingMountainsCampaignPlan;
};

export function MovingMountainsCampaignPanel({
  plan,
}: MovingMountainsCampaignPanelProps) {
  if (!plan.canReadPlan) {
    return null;
  }
