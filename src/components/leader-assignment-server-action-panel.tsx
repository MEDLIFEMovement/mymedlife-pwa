    ...
    <section className="rounded-[2rem] border border-lime-300/20 bg-lime-300/10 p-5">
      ...
      <form action={createLeaderAssignmentAction} className="mt-5 space-y-4">
        ...
        <textarea
          ...
          className="min-h-24 w-full rounded-2xl border border-white/10 bg-black/30 p-3 text-sm text-white outline-none disabled:cursor-not-allowed disabled:text-white/38"
        ...
        <button
          type="submit"
          disabled={!readiness.canSubmit}
          className="w-full rounded-full bg-lime-200 px-5 py-3 text-sm font-semibold text-[#06211d] transition hover:bg-lime-100 disabled:cursor-not-allowed disabled:bg-white/12 disabled:text-white/38 sm:w-auto"
        >
