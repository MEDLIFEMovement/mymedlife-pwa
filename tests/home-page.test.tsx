...
describe("home page", () => {
  it("renders the exact Figma general member mobile shell", async () => {
    ...
    expect(html).toContain("My Points");
    ...
    expect(html).toContain("TEST Rush Month preview");
    expect(html).toContain("Production assignment readback is not connected.");
    expect(html).toContain("Production coach-message readback is not connected.");
    expect(html).not.toContain("67% complete");
    expect(html).not.toContain("22 / 34 members active");
    expect(html).toContain("Chapter Leaderboard");
    expect(html).toContain("Open profile and chapter scope");
