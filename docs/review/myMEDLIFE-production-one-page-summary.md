...
- Live external sends and broad writes remain off by default.
...
Do not enable live external sends or broad writes until the approvals above are
recorded and the hosted proof is visible.
