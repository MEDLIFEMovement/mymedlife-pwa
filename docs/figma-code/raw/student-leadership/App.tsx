...
import { CreateEventForm } from "./CreateEventScreen";
import { TrainingScreen } from "./TrainingScreen";
import { MedlifeStoriesScreen } from "./StoriesScreen";
...
const ROLES_TO_TRANSITION = [
  { id:"president",   label:"President",               committee:"E-Board",           color:"#1A56E8" },
  { id:"vp-events",   label:"VP of Events",            committee:"E-Board",           color:"#7C3AED" },
  { id:"vp-comms",    label:"VP of Communications",    committee:"E-Board",           color:"#DB2777" },
  { id:"recruitment", label:"Recruitment Chair",       committee:"Recruitment",        color:"#0891B2" },
  { id:"fundraising", label:"Fundraising Chair",       committee:"Fundraising",        color:"#D97706" },
  { id:"engagement",  label:"Member Engagement Chair", committee:"Member Engagement", color:"#DC2626" },
  { id:"slt",         label:"SLT Promotion Chair",     committee:"SLT Promotion",     color:"#7C3AED" },
  { id:"service",     label:"Service Chair",           committee:"Service",            color:"#059669" },
];
