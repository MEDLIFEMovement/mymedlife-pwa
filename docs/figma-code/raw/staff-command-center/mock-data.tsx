...
const API_KEYS_DATA = [
  { id: "luma", provider: "Luma", label: "Luma API Key", key: "REDACTED_DEMO_LUMA_KEY", environment: "production", status: "active", lastRotated: "2026-05-10", expiresAt: "2027-05-10", createdBy: "Chen Wei", scopes: ["events:read", "events:write", "rsvp:read"] },
  { id: "hubspot", provider: "HubSpot", label: "HubSpot Private App Token", key: "REDACTED_DEMO_HUBSPOT_TOKEN", environment: "production", status: "active", lastRotated: "2026-04-01", expiresAt: "Never", createdBy: "Soledad Vega", scopes: ["contacts:write", "contacts:read", "deals:read"] },
  { id: "bigquery", provider: "BigQuery", label: "BigQuery Service Account Key", key: "REDACTED_DEMO_BIGQUERY_KEY", environment: "production", status: "active", lastRotated: "2026-03-15", expiresAt: "Never", createdBy: "Chen Wei", scopes: ["bigquery.tables.create", "bigquery.jobs.create"] },
  { id: "n8n", provider: "n8n", label: "n8n Webhook Secret", key: "REDACTED_DEMO_N8N_SECRET", environment: "production", status: "active", lastRotated: "2026-06-01", expiresAt: "Never", createdBy: "Chen Wei", scopes: ["webhook:receive"] },
  { id: "openai", provider: "OpenAI", label: "OpenAI API Key", key: "REDACTED_DEMO_OPENAI_KEY", environment: "internal", status: "inactive", lastRotated: "2026-02-20", expiresAt: "Never", createdBy: "Chen Wei", scopes: ["completions", "chat"] },
  { id: "powerbi", provider: "Power BI", label: "Power BI Client Secret", key: "REDACTED_DEMO_POWERBI_SECRET", environment: "staging", status: "inactive", lastRotated: "2025-12-01", expiresAt: "2026-12-01", createdBy: "Soledad Vega", scopes: ["dataset:read", "report:read"] },
];
        ...
        <div className="grid grid-cols-2 gap-4">
          {mods.map((mod) => (
            ...
            >
              ...
              <div className="text-[11px] text-slate-600 italic border-l-2 border-white/[0.05] pl-2">"{mod.reason}"</div>
              ...
              <div className="space-y-4">
                ...
                {chapterPoints && (
                  <div className="bg-[#161b22] border border-white/[0.06] rounded-lg p-4 space-y-3">
                    ...
                    <div className="text-[10px] text-slate-600 leading-relaxed">Points added to the chapter's total when any member completes a step.</div>
                    <input
                      type="number"
                      defaultValue={25}
...
function SmileioCard() {
  ...
  const MOCK_KEY = "smile_sk_live_9Xk2Mn4Pq7Rt1Vw3YzAbCdEfGh";
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-[#0d1117]/70 border border-white/[0.06] rounded px-3 py-2 font-mono text-[11px] text-slate-300 overflow-hidden">
                    {keyRevealed ? MOCK_KEY : `smile_sk_live_${"•".repeat(16)}${MOCK_KEY.slice(-4)}`}
                  </div>
                  <button
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-[#0d1117]/70 border border-white/[0.06] rounded px-3 py-2 font-mono text-[11px] text-slate-300 overflow-hidden">
                    {tokenRevealed ? "REDACTED_DEMO_SYSTEM_TOKEN" : `demo_token_${"•".repeat(20)}safe`}
                  </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-[12px] text-slate-500 mt-0.5">Each chapter links one Facebook Page. Posts are published on behalf of the chapter's page admins.</p>
              </div>
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-[#0d1117]/70 border border-white/[0.06] rounded px-3 py-2 font-mono text-[11px] text-slate-300 overflow-hidden">
                    {secretRevealed ? "REDACTED_DEMO_CLIENT_SECRET" : `demo_secret_${"•".repeat(20)}safe`}
                  </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-[12px] text-slate-500 mt-0.5">Each chapter's connected social profiles are managed as a Hootsuite stream. Staff can compose, approve, and schedule across all at once.</p>
              </div>
              <button className="flex items-center gap-1.5 px-3 py-1.5 bg-sky-500/10 text-sky-400 border border-sky-500/20 rounded text-[11px] font-medium hover:bg-sky-500/18 transition-colors">
...
// ─── Password Gate Modal ────────────────────────────────────────────────────────
const MOCK_PASSWORD = "REDACTED_DEMO_PASSWORD";
...
export function AdminPanel({ onBack }: { onBack?: () => void }) {
  ...
  return (
    <div className="flex h-full bg-[#0d1117] overflow-hidden" style={{ fontFamily: "'Manrope', system-ui, sans-serif" }}>
